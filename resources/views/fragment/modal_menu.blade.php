        ...
        <div class="modal__body mt-0 m-2 row">
            <div class="col-3 d-flex justify-content-center align-items-center p-0">
                <div class="image__container d-flex justify-content-center align-items-center">
                    ...
                    <img id="ico__mgeneral" src="{{ asset('assets/icons/mantenimiento-tiny.png') }}" width="60%" alt="Icono Mantenimiento General" class="d-none animate__zoomIn animate__animated">

                    <img id="ico__mindustrial" src="{{ asset('assets/icons/mantenimientoInd-tiny.png') }}" width="60%" alt="Icono Mantenimiento Industrial" class="d-none animate__zoomIn animate__animated">
                </div>
            </div>
            <div class="col-4 p-0">
                <ul class="sub__menu">
                    ...
                    <li><a class="mega__link" href="{{route ('mtto-gral') }}">Mantenimiento General</a></li>
                    <li><a class="mega__link" href="{{route ('mtto-industrial') }}">Mantenimiento Industrial</a></li>
                </ul>
            </div>
            <div class="col-5 d-flex justify-content-center align-items-center p-0">
                <div class="image__container d-flex justify-content-center align-items-center">
                    ...
                    <img id="img__mgeneral" src="{{ asset('assets/img/img-mtto-gral.png') }}" width="40%" alt="Imagen alusiva al servicio Mantenimiento General" class="d-none animate__zoomIn animate__animated">

                    <img id="img__mindustrial" src="{{ asset('assets/img/img-mtto-ind.png') }}" width="60%" alt="Imagen alusiva al Mantenimiento Industrial" class="d-none animate__zoomIn animate__animated">
                </div>
            </div>
        </div>
    </div>
