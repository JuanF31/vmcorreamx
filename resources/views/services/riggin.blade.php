...
@section('title')
    <title>{{ config('app.name') }} · Riggin</title>
@endsection
    ...
    <div class="seccion__body">
        ...
        <header class="header__container">
            ...
            <div class="flex__box" data-aos="fade-up">
                <img src="{{ asset('assets/banners/Banner_Servicio_Riggin.png') }}"  alt="Banner Riggin">
            </div>
        </header>
        <!-- End header -->
        ...
        <div class="contenedor">
                        ...
                        <div class="container">
                            <div class="row" data-aos="fade-up">
                                ...
                                <div class="col-lg-5 col-sm-12 flex__box">
                                    <img src="{{ asset('assets/icons/Riggin-tiny.png') }}" loading="lazy" class="rounded" alt="Riggin" width="60%">
                                </div>
                            </div>
                            <div class="row">
            ...
            <div class="flex__box" data-aos="fade-up">
                <img src="{{ asset('assets/img/riggin.png') }}"  alt="Imagen Riggin">
            </div>
