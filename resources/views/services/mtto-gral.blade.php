...
@section('title')
<title>{{ config('app.name') }} · Mantenimiento General</title>
@endsection
        ...
        <div class="seccion__body">
            ...
            <header class="header__container">
                ...
                <div class="slider__hero" data-aos="fade-up">
                    <img src="{{ asset('assets/banners/Banner_Servicio_MttoGral.png') }}" alt="Banner Riggin">
                </div>
            </header>
            <!-- End header -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="text-center">
                                                <img src="{{ asset('assets/icons/mantenimiento-tiny.png') }}" loading="lazy" class="rounded" alt="Mantenimiento General" width="70%">
                                            </div>                        
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="flex__box" data-aos="fade-up">
                <img src="{{ asset('assets/img/mtto_general.png') }}">
            </div>
