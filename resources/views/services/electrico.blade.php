...
@section('title')
    <title>{{ config('app.name') }} · Eléctrico</title>
@endsection
    ...
    <div class="seccion__body">
        ...
        <header class="header__container">
            ...
            <div class="flex__box" data-aos="fade-up">
                <img src="{{ asset('assets/banners/Banner_Servicio_Electrico.png') }}"  alt="Banner Electrico">
            </div>
        </header>
        <!-- End header -->
        ...
        <div class="contenedor">
                        ...
                        <div class="container">
                            <div class="row" data-aos="fade-up">
                                ...
                                <div class="col-lg-5 col-sm-12 flex__box">
                                    <img src="{{ asset('assets/icons/electrico.png') }}" loading="lazy" class="rounded" alt="Riggin" width="60%">
                                </div>
                            </div>
                            <div class="row">
            ...
            <div class="flex__box" data-aos="fade-up">
                <img src="{{ asset('assets/img/serv-electrico.png') }}"  alt="Imagen Riggin">
            </div>
